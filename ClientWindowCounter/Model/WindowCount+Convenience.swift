...
extension WindowCount {
    @discardableResult convenience init(countDescription: String, bigWindow: Int, regularWindow: Int, smallWindow: Int, smallLadder: Int, bigLadder: Int, hardWater: Int, screen: Int, hardWaterSmall: Int, construction: Int, track: Int, discount: Double, totalPrice: String, client: Client, context: NSManagedObjectContext = CoreDataStack.context) {
